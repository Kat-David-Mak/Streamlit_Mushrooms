...
print('Random ForestClassifier Model Accuracy:   ', accuracy_score(Y_test, y_pred))
print('Random ForestClassifier Confusion Matrix: ', c_matrix)
print('Random ForestClassifier Precision Score: ', pre_score)
print('Random ForestClassifier Recall Score: ', r_score)